		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nryzyappempleados-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nryzyappempleados-display": {
								"semanticObject": "nryzyappempleados",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nryzy.appempleados",
									"url": sap.ui.require.toUrl("nryzy/appempleados")
								}
							}
						}
					}
